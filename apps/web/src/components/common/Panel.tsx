...
export function Panel({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col gap-6 rounded-[1.9rem] border border-white/15 bg-slate-900/55 p-7 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
