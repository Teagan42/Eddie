...
import { CardStackIcon, ChatBubbleIcon, Pencil1Icon, TrashIcon } from '@radix-ui/react-icons';
      ...
      <Flex gap="2" wrap="wrap">
        {sessions.length === 0 ? (
          ...
          sessions.map((session) => {
            ...
            const metricsDescription = formattedMetrics
            ...
            const editLabel = `Edit ${session.title}`;
