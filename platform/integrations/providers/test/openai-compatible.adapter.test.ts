...
describe("OpenAICompatibleAdapter", () => {
  ...
  it("treats think tags with attributes as reasoning content", async () => {
    const chunks = [
      'data: {"choices":[{"delta":{"content":"<think reason=\\"plan\\">Hidden</think>"}}]}\n',
      'data: {"choices":[{"delta":{"content":"Visible"},"finish_reason":"stop"}]}\n',
      'data: [DONE]\n',
    ];
  ...
  it("buffers attribute-rich think start segments spanning chunks", async () => {
    const chunks = [
      'data: {"choices":[{"delta":{"content":"<think reason=\\"plan\\""}}]}\n',
      'data: {"choices":[{"delta":{"content":" stage>Hidden</think>"}}]}\n',
      'data: {"choices":[{"delta":{"content":"Visible"},"finish_reason":"stop"}]}\n',
      'data: [DONE]\n',
    ];
